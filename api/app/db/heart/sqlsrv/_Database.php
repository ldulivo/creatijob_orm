...
abstract class _Database
{
     ...
     * -----
     * Description:
     * Establishes and returns a PDO connection to the SQL Server database.
    ...
    public static function getConnection()
    {
        try {
            if (!self::$pdo) {
                $dsn = 'sqlsrv:Server=' . Config\SQLSRV_HOST . ',' . Config\SQLSRV_PORT . ';Database=' . Config\SQLSRV_DBNAME;
                self::$pdo = new PDO($dsn, Config\SQLSRV_USERNAME, Config\SQLSRV_PASSWORD);
